...
public class QingjiaController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,QingjiaEntity qingjia, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xuesheng")) {
			qingjia.setXuehao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,QingjiaEntity qingjia, HttpServletRequest request){
    ...
    public R add(@RequestBody QingjiaEntity qingjia, HttpServletRequest request){
    	qingjia.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(qingjia);
    	qingjia.setUserid((Long)request.getSession().getAttribute("userId"));
